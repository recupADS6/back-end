...
public interface JobRepository extends JpaRepository<Job, Long> {
	...
	public Optional<Job> findByLeve(String level);
	
	@Query("select j from Job j where j.level = ?1")
	public Optional<Job> buscarPorNivel(String title);
	
	public Optional<Job> findByDescription(String tdescriptionitle);
